...
const Noc = ({ navigation }) => {
  ...
  // --------------1st date-------------
  const [isDateOfImportVisible, setDateOfImportVisibility] = useState(false);
  const [isCalendarVisible, setCalendarVisibility] = useState(false);
  const [isCalendarSecondVisible, setCalendarSecondVisibility] = useState(false);
  const [isCalendarThirdVisible, setCalendarThirdVisibility] = useState(false);

  const [selectedDateOfImport, setSelectedDateOfImport] = useState(null);
  ...
  const showDateOfImportCalendar = () => {
    setDateOfImportVisibility(true);
  }

  const hideDateOfImportCalendar = () => {
    setDateOfImportVisibility(false);
  }
  ...
  const handleDateSelected = (date, picker) => {
    const formattedDate =
    ...
    switch (picker) {
      ...
      case 'second':
        ...
        break;
      case 'third':
        setmeddate(formattedDate);
        setSelectedThirdDate(date);
        break;
      case 'dateOfImport':
        setdateofim(formattedDate);
        setSelectedDateOfImport(date);
        break;
    }
  ...
  const showCalendarSecond = () => {
    setCalendarSecondVisibility(true);
  };

  const hideCalendarSecond = () => {
    setCalendarSecondVisibility(false);
  };

  const showCalendarThird = () => {
    setCalendarThirdVisibility(true);
  };

  const hideCalendarThird = () => {
    setCalendarThirdVisibility(false);
  };
  ...
  return (
    <View style={styles.root}>
      ...
      <View style={[mainStyle.view1, { marginBottom: hp(2) }]}>
        ...
        <Text style={styles.title}>No Objection Certificate (NOC)</Text>
      ...
      <ScrollView
        ...
        <TouchableOpacity onPress={showDateOfImportCalendar}>
          <TextBox
            dis={false}
            top="1"
            bcolor="#ECECEC"
        ...
        <View style={mainStyle.view1}>
          <View>
            ...
            <TouchableOpacity onPress={showCalendarSecond}>
              <TextBox
                dis={false}
                top="1"
                wid="43"
        ...
        <View style={mainStyle.view1}>
          <View>
            <Text style={styles.subhead}>Date</Text>
            <TouchableOpacity onPress={showCalendarThird}>
              <TextBox
                dis={false}
                top="1"
                wid="43"
        ...
        <Modal visible={isDateOfImportVisible} transparent={true} animationType="slide">
          <View style={styles.modalContainer}>
            <Calendar
              onDateSelected={(date) => handleDateSelected(date, 'dateOfImport')}
              closeCalendar={hideDateOfImportCalendar}
              initialSelectedDate={selectedDateOfImport}
            />
          </View>
        </Modal>
        ...
        <Modal visible={isCalendarVisible} transparent={true} animationType="slide">
          <View style={styles.modalContainer}>
            <Calendar
              onDateSelected={(date) => handleDateSelected(date, 'first')}
              closeCalendar={hideCalendar}
              initialSelectedDate={selectedFirstDate}
            />
          </View>
        </Modal>

        <Modal visible={isCalendarSecondVisible} transparent={true} animationType="slide">
          <View style={styles.modalContainer}>
            <Calendar
              onDateSelected={(date) => handleDateSelected(date, 'second')}
              closeCalendar={hideCalendarSecond}
              initialSelectedDate={selectedSecondDate}
            />
          </View>
        </Modal>

        <Modal visible={isCalendarThirdVisible} transparent={true} animationType="slide">
          <View style={styles.modalContainer}>
            <Calendar
              onDateSelected={(date) => handleDateSelected(date, 'third')}
              closeCalendar={hideCalendarThird}
              initialSelectedDate={selectedThirdDate}
            />
          </View>
        </Modal>
