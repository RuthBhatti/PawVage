      ...
      <ScrollView
        ...
        <View style={mainStyle.view1}>
          <View>
            ...
            <TouchableOpacity onPress={showDatePickersecond}>
              <TextBox
                dis={false}
                top="1"
                wid="43"
        ...
        <View style={mainStyle.view1}>
          <View>
            <Text style={styles.subhead}>Date</Text>
            <TouchableOpacity onPress={showDatePickerthird}>
              <TextBox
                dis={false}
                top="1"
                wid="43"
        ...
        <DateTimePicker
          isVisible={thirddate}
          mode="date"
          onConfirm={handleConfirmthird}
          onCancel={hideDatePickerthird}
        />
